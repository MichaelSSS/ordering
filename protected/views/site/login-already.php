...
<div class="wrp">
    <div class="span7 offset2">
        <div class="panel panel-warning">
            ...
            <div class="panel-footer"><p class=" text-center">Click <a href="<?= Yii::app()->createUrl('site/forceLogin');?>"> here </a>  to log in current browser. Your session in another browser will be ended</p></div>
        </div>
    </div>
</div>
